(function ($) {
          ...
          function mask() {
            ...
            if (settings.precision > 0) {
              if (decimalPointIndex < 0) {
                value +=
                  settings.decimal + new Array(settings.precision + 1).join(0);
              } else {
                ...
                value =
                  ...
                  settings.decimal +
                  decimalPart +
                  new Array(settings.precision + 1 - decimalPart.length).join(
                    0
                  );
              }
  ...
  function maskValueReverse(value, settings) {
    ...
    if (settings.precision > 0) {
      ...
      var rounded = Number.parseFloat(integerPart + "." + decimalPart).toFixed(
        settings.precision
      );

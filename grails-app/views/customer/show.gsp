<html>
    ...
    <body>
   <form data-redirect-url="${ g.createLink(controller: 'payer', action: 'create') }"
        ...
        <input type="text" name="district" id="district" placeholder="Bairro"value="${ customer?.province}" readonly><br>
